...
import ExampleSection from "../../sections/FunctionalSections/ExampleSection/ExampleSection";
import LastSection from "../../sections/FunctionalSections/LastSection/LastSection";
...
export default function FunctionalPage(props) {
  ...
  const [examples1, setExamples1] = useState([{ id: Date.now(), text: "", source: "" }]);
  const [examples2, setExamples2] = useState([{ id: Date.now(), text: "", source: "" }]);
  const [examples3, setExamples3] = useState([{ id: Date.now(), text: "", source: "" }]);
