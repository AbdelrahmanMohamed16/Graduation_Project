...
export default function AccordionWithWords() {
  ...
  const [wordData, setWordData] = React.useState([
    ...
    { word: 'عين', status: 'ناقصة', meanings: ['معنى 1', 'معنى 2', 'معنى 3', 'معنى 4'] },
  ...
  const moveMeaningUp = (wordIndex, meaningIndex) => {
    ...
    newWordData[wordIndex].meanings[meaningIndex] = newWordData[wordIndex].meanings[meaningIndex - 1];
  ...
  return (
    <div style={{ direction: 'rtl' }}>
      <Navbar navItems={[{ id: 'section1', text: 'الأول' }, { id: 'section2', text: 'الثاني' }]} setWord={() => {}} />
      <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginTop: '40px' }}>
        <div style={{ width: '85%', maxWidth: '900px', marginRight: '20px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '5px' }}>
                      <button
                        ...
                        style={{
                          ...
                          border: 'none',
                          cursor: meaningIndex === 0 ? 'not-allowed' : 'pointer',
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor: 'transparent',
                          border: 'none',
                          cursor: meaningIndex === item.meanings.length - 1 ? 'not-allowed' : 'pointer',
                          color: index % 2 === 0 ? '#0F2D4D' : '#F0F0F0',
                        }}
                      >
