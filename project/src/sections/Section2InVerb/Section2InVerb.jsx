      ...
      >
        ...
        <Grid size={{ xs: 12, sm: 5, md: 4, lg: 3 }}>
          ...
          <InputField
            ...
            name={"word_class"}
            MorphologicalInfo={true}
            val={form_morphological_info?.word_class} //change it to based on the body of the backend
            defaultOption={form_morphological_info?.word_class} //change it to based on the body of the backend
            options={[
              "فَعَل",
              "فَعُل",
              "فَعِل",
